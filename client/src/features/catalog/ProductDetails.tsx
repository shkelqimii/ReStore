...
export default function ProductDetails() {
    ...
    const productId = parseInt(id!); // Assuming id is always valid. Consider validating this assumption.
    ...
    useEffect(() => {
        ...
        if (!product && id !== undefined) dispatch(fetchProductAsync(productId));
                    ...
                    <Table>
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell>{product.quantityInStock ?? 'N/A'}</TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                </TableContainer>
